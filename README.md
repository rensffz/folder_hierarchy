...
* JSON-данные дополнительно валидируются при инициализации таблицы, т. к. данные могут быть любыми (нет проверок 
при инициализации таблицы автоматическими методами);
